    ...
    <form action="{{ route('inventories.update', $inventory->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Cost:</strong>
                    <input type="number" step="0.01" name="cost" class="form-control" placeholder="{{ $inventory->cost }}"
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" name="quantity" class="form-control" placeholder="{{ $inventory->quantity }}"
